...
resource "aws_security_group" "k8s-security-group" {
  ...
  tags = {
    ...
    owner     = "RGA"
    yor_trace = "f11f0af5-7391-4229-9f28-85cbf69c6ca0"
  }
}
...
resource "aws_instance" "ci-sockshop-k8s-master" {
  ...
  tags = {
    ...
    git_repo  = "microservices-demo"
    owner     = "RGA"
    yor_trace = "cb48e226-87a9-4890-86f1-fdd0b3947627"
  }
}
...
resource "aws_instance" "ci-sockshop-k8s-node" {
  ...
  tags = {
    ...
    git_repo  = "microservices-demo"
    owner     = "RGA"
    yor_trace = "42b693e5-7e75-4d67-bd71-9e5d9232fa2f"
  }
}
...
resource "aws_elb" "ci-sockshop-k8s-elb" {
  ...
  tags = {
    ...
    git_repo  = "microservices-demo"
    owner     = "RGA"
    yor_trace = "4de9c2e7-0fea-4860-a24e-38a39163788c"
  }
}
