...
resource "aws_security_group" "k8s-security-group" {
  ...
  tags = {
    ...
    yor_trace = "cfc5c09f-476d-47de-ae2d-0c9a9573f859"
  }
}
...
resource "aws_instance" "ci-sockshop-k8s-master" {
  ...
  tags = {
    git_org   = "RadoGar"
    git_repo  = "microservices-demo"
    yor_trace = "d1597680-1070-436b-87fd-24166469584e"
  }
}
...
resource "aws_instance" "ci-sockshop-k8s-node" {
  ...
  tags = {
    git_org   = "RadoGar"
    git_repo  = "microservices-demo"
    yor_trace = "3792f882-ebae-4b27-9d49-7a42985bbf1a"
  }
}
...
resource "aws_elb" "ci-sockshop-k8s-elb" {
  ...
  tags = {
    git_org   = "RadoGar"
    git_repo  = "microservices-demo"
    yor_trace = "e2570b08-9f4f-437e-9c62-accd0033c784"
  }
}
