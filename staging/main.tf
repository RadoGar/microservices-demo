...
resource "aws_security_group" "microservices-demo-staging-k8s" {
  ...
  tags = {
    ...
    owner     = "RGA"
    yor_trace = "43821f80-472d-4c85-84d4-f517442ca740"
  }
}
...
resource "aws_instance" "k8s-node" {
  ...
  tags = {
    ...
    git_repo  = "microservices-demo"
    owner     = "RGA"
    yor_trace = "260f9288-6608-4b98-9bbb-cd7d70b7f27e"
  }
}
...
resource "aws_instance" "k8s-master" {
  ...
  tags = {
    ...
    git_repo  = "microservices-demo"
    owner     = "RGA"
    yor_trace = "2a555519-f6b9-49ba-9102-b176be98cc04"
  }
}
...
resource "aws_elb" "microservices-demo-staging-k8s" {
  ...
  tags = {
    ...
    git_repo  = "microservices-demo"
    owner     = "RGA"
    yor_trace = "44b4ef83-bc61-4703-b889-e3a6dbc559b7"
  }
}
